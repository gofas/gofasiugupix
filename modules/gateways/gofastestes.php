 ...
 * example file, the filename is "gofastestes" and therefore all functions
 * begin "gofastestes_".
 *
 ...
 * @return string
 */
function gofastestes_link($params)
{
 ...
 */
function gofastestes_refund($params)
{
    // Gateway Configuration Parameters
    $accountId = $params['accountID'];
    $secretKey = $params['secretKey'];
 ...
 * @return array Transaction response status
 */
function gofastestes_cancelSubscription($params)
{
    // Gateway Configuration Parameters
    $accountId = $params['accountID'];
    $secretKey = $params['secretKey'];
